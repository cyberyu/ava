...
def getSess():
    ...
    flags.DEFINE_string(
        "export_dir", './export_amelia/bert_small_sharepoint_10epoch_dropout/',
        "The dir where the exported model has been written.")
    
    tokenizer = tokenization.FullTokenizer(vocab_file='./bert_model_serve_sharepoint/vocab.txt', do_lower_case=True)
